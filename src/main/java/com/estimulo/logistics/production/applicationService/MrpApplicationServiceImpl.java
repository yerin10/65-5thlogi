...
import com.estimulo.logistics.production.repository.MrpGatheringRepository;
import com.estimulo.logistics.production.repository.MrpRepository;
...
public class MrpApplicationServiceImpl implements MrpApplicationService {
	...
	@Autowired
	private MrpGatheringRepository mrpGatheringRepository;
	...
	public ArrayList<MrpGatheringTO> searchMrpGatheringList(String dateSearchCondtion, String startDate,
		...
		HashMap<String, String> param = new HashMap<>();
			param.put("searchDateCondition",dateSearchCondtion);
			param.put("startDate",startDate);
			param.put("endDate",endDate);
			 ...
			 * 
			 * bean.setMrpTOList( mrpDAO.selectMrpListAsMrpGatheringNo(
			 * bean.getMrpGatheringNo()) );
			 * 
			 * }
			 */
	...
	public HashMap<String, Object> registerMrp(String mrpRegisterDate, ArrayList<MrpTO> newMrpList) {
		...
		HashMap<String, Object> resultMap = null;
			...
			// �깉濡쒖슫 MRP �씪�젴踰덊샇 �뼇�떇 �깮�꽦 : �벑濡앹씪�옄 '2018-01-01' => �씪�젴踰덊샇 'RP20180101-'
	...
	public HashMap<String, Object> registerMrpGathering(String mrpGatheringRegisterDate,
		...
		HashMap<String, Object> resultMap = null;
			...
			// �깉濡쒖슫 mrpGathering �씪�젴踰덊샇 �뼇�떇 �깮�꽦 : �벑濡앹씪�옄 '2018-01-01' => �씪�젴踰덊샇 'MG20180101-'
			...
			for (MrpGatheringTO bean : newMrpGatheringList) {
				...
				//System.out.println("L:::::::::::::::::::::::"+newMrpGatheringNo.toString() + String.format("%03d", i++));
				bean.setStatus("INSERT");
			...
			for (String mrpGatheringNo : mrpGatheringNoList.values()) {
				System.out.println("mrpGatheringNoList.values():::"+mrpGatheringNoList.values());
